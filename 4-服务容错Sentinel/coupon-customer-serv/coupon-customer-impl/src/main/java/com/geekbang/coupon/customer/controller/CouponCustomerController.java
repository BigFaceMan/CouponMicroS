...
public class CouponCustomerController {
    ...
    @SentinelResource(value = "customer-findCoupon", blockHandler = "findCoupon_block")
    public List<CouponInfo> findCoupon(@Valid @RequestBody SearchCoupon request) {
        return customerService.findCoupon(request);
    }

    public List<CouponInfo> findCoupon_block(@Valid @RequestBody SearchCoupon request, BlockException blockException) {
        log.info("findCoupon被限流了，blockException={}", blockException.getMessage());
        // 这里可以返回一个空的结果集
