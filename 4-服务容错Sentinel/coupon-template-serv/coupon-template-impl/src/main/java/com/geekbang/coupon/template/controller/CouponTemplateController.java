...
//            }
    ...
    // 接口被降级时的方法
    public Map<Long, CouponTemplateInfo> getTemplateInBatch_fallback(Collection<Long> ids) throws AccessDeniedException {
        log.info("接口被降级");
//        throw new AccessDeniedException("访问超时");
        return Maps.newHashMap();
    }

    // 流控降级的方法
    public Map<Long, CouponTemplateInfo> getTemplateInBatch_block(
            Collection<Long> ids, BlockException e) throws AccessDeniedException {
        log.info("接口被限流");
//        throw new AccessDeniedException("访问超时");
        return Maps.newHashMap();
    }
